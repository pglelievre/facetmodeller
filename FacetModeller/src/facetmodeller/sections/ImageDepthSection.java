...
/** Horizontal depth-section with an image.
 * @author Peter
 */
public class ImageDepthSection extends DepthSection {
    ...
    public ImageDepthSection() { // required by the SessionLoader (should not be used elsewhere)
        super();
        imageSection = new ImageSection();
    }
    
    public ImageDepthSection(File f) {
        super();
...
//    }
//    @Override
//    public ImageDepthSection undoCopy() {
//        ImageDepthSection s = new ImageDepthSection();
...
//    }
    ...
    @Override
    public int getType() { return Section.SECTION_IMAGE_DEPTH; }
    @Override
...
//    }
    ...
    @Override
    public CommandVector snapToCalibration(double snappingDistance, GroupVector groups, boolean doH, boolean doV) {
        if (!doH) { return null; } // can't shift vertically on a depth section
        return super.snapToCalibration(snappingDistance,groups,doH,doV);
    }
